...
<div class="container-fluid">
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form class=" form-signin" action="/menus/{{ $menu->id_makanan }}" method="POST" enctype="multipart/form-data">
                @method('put')
                @csrf
                <div class="form-group">
                    <label for="nama">Nama Makanan</label>
                    <input type="text" class="form-control @error('nama_makanan') is-invalid @enderror" id="nama_makanan"
                        placeholder="Masukan Nama" name="nama_makanan" value="{{ $menu->nama_makanan }}">
                    @error('nama_makanan')
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control @error('harga_makanan') is-invalid @enderror" id="harga_makanan"
                        placeholder="Masukan Harga" name="harga_makanan" value="{{ $menu->harga_makanan }}">
                    @error('harga_makanan')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control @error('qty_makanan') is-invalid @enderror" id="qty_makanan"
                        placeholder="Masukan Stok Makanan" name="qty_makanan" value="{{ $menu->qty_makanan }}">
                    @error('qty_makanan')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="file" class="form-control @error('gambar_makanan') is-invalid @enderror" id="gambar_makanan"
                        placeholder="Masukan Stok Makanan" name="gambar_makanan" value="{{ $menu->gambar_makanan }}">
